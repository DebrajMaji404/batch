...
/**
 * A poiji {@link Casting} implementation for parsing dates/enums.
 *
 * NOTE: currently unused by the rest of this library. Both
 * {@link CSVItemReader} and {@link ExcelItemReaderWithHeaderValidation} do
 * their own manual field-by-field parsing rather than using poiji + this
 * class. Kept as a public utility in case you're driving poiji directly in
 * your own reader, but it's not wired into anything generated by
 * {@code @BatchJob}.
 */
